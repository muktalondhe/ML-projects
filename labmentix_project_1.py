...
Original file is located at
    https://colab.research.google.com/drive/10iFOlmXP0Gwmn63Wkh-Jax9l112ZnsSj
...
**Project Summary** -Yes Bank is a well-known bank in the Indian financial domain. Since 2018, it has been in the news due to various financial and operational challenges. This project aims to predict the closing price of Yes Bank's stock using regression and supervised machine learning techniques. The analysis involves exploratory data analysis (EDA), visualization, and the application of machine learning models such as Linear Regression, Random Forest Regressor, and XGBoost Regressor. The dataset used contains historical stock prices from 2005 to 2020, including features like Open, High, Low, and Close prices. The goal is to build a predictive model that can accurately forecast the closing price, which can be valuable for investors and financial analysts. The project is an individual contribution by Mukta Arvind Londhe, and the code is shared on GitHub.
...
The project leverages Python libraries such as Pandas, NumPy, Scikit-learn, and XGBoost for data manipulation, analysis, and modeling. The problem statement focuses on forecasting the closing price to aid in financial decision-making.

GitHub Link -https://github.com/muktalondhe
